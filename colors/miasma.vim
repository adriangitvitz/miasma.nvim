...
hi Boolean guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ColorColumn guifg=NONE guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi Comment guifg=#b4b4b4 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi Constant guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi CursorColumn guifg=NONE guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi Cursor guifg=#2B1F1A guibg=#c2b19e guisp=NONE blend=NONE gui=NONE
hi CursorLine guifg=NONE guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi CursorLineNr guifg=#afb687 guibg=#2B1F1A guisp=NONE blend=NONE gui=bold
...
hi DiagnosticError guifg=#e4a581 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticHintFloating guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticHint guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticInfo guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticOk guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignError guifg=#e4a581 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignHint guifg=#99ba98 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignInfo guifg=#afb687 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignWarn guifg=#c2b19e guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticVirtualTextError guifg=#e4a581 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextHint guifg=#afb687 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextInfo guifg=#afb687 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarn guifg=#c2b19e guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarning guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarn guifg=#c2b19e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarningFloating guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarning guifg=#e4a581 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiffAdded guifg=#99ba98 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi DiffAdd guifg=#2B1F1A guibg=#99ba98 guisp=NONE blend=NONE gui=NONE
hi DiffChange guifg=#2B1F1A guibg=#c2b19e guisp=NONE blend=NONE gui=NONE
hi DiffDelete guifg=#2B1F1A guibg=#e4a581 guisp=NONE blend=NONE gui=bold
hi DiffRemoved guifg=#e4a581 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
...
hi ErrorMsg guifg=#e4a581 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
...
hi Function guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi GitSignsAdd guifg=#99ba98 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi GitSignsChange guifg=#c2b19e guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi GitSignsDelete guifg=#e4a581 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
...
hi IncSearch guifg=#2B1F1A guibg=#dea277 guisp=NONE blend=NONE gui=NONE
hi Keyword guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi LineNr guifg=#b4b4b4 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
...
hi Normal guifg=#D7C483 guibg=#2B1F1A guisp=NONE blend=NONE gui=NONE
hi Number guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi Search guifg=#2B1F1A guibg=#99ba98 guisp=NONE blend=NONE gui=NONE
...
hi Statement guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=bold
...
hi String guifg=#c2b19e guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi Type guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=bold
...
hi Visual guifg=#2B1F1A guibg=#afb687 guisp=NONE blend=NONE gui=NONE
...
hi Character guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi Float guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi @boolean guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @character guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @character.special guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @comment guifg=#b4b4b4 guibg=NONE guisp=NONE blend=NONE gui=italic
hi @conditional guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=bold
hi @constant.builtin guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @constant guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @constant.macro guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @constructor guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @error guifg=#e4a581 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @exception guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=bold
hi @field guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @float guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @function.builtin guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @function guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @function.macro guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @include guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @keyword.function guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @keyword guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @label guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @method guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @namespace guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @number guifg=#afb687 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @operator guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @parameter guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @preproc guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @property guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @punctuation.bracket guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @punctuation.delimiter guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @punctuation.special guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @repeat guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=bold
hi @string.escape guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @string guifg=#c2b19e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @string.regex guifg=#c2b19e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @string.special guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @tag.attribute guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @tag.delimiter guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @tag guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi @text.warning guifg=#e4a581 guibg=NONE guisp=NONE blend=NONE gui=bold
hi @type.builtin guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @type guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @type.definition guifg=#afb788 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @type.qualifier guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @variable.builtin guifg=#dea277 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @variable guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE

" Language Specific Treesitter
hi @field.yaml guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @label.json guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi @property.toml guifg=#99ba98 guibg=NONE guisp=NONE blend=NONE gui=NONE
